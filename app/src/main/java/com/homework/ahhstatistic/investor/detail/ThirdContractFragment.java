...
public class ThirdContractFragment extends Fragment {
    private String bundlePass;
    private static final String contract = "3rd";
    ...
    private void DownloadImage() {
        ...
        request.setDestinationInExternalPublicDir(Environment.DIRECTORY_DOWNLOADS, "Invescog/Expired/3rd/expired 3rd.png");
        request.setMimeType("*/*");
    ...
    private void RetrieveContractOneData() {
        collRef.document(bundlePass)
                .collection("Third Date").orderBy("currentTime", Query.Direction.DESCENDING)
