...
public class FirstContractFragment extends Fragment {
    ...
    private void DownloadImage() {
        ...
        request.setDestinationInExternalPublicDir(Environment.DIRECTORY_DOWNLOADS, "Invescog/Expired/1st/expired 1st.png");
        request.setMimeType("*/*");
    ...
    private void RetrieveContractOneData() {
        collRef.document(bundlePass)
                .collection("First Date").orderBy("currentTime", Query.Direction.DESCENDING)
